	...
	<div class="wrapper">
			...
			<div class="lheader__wrapper">
				<div class="lheader__items">
					...
					<div class="lheader__items_item_small lheader__phone">
						<a class="lheader__phone_link" href="tel:88007750357"
							>8 800 775-03-57</a
						>
						<span
		...
		<section class="lcontent">
			<div class="banner_girl">
				<img src="/potolki/images/banner-girl-mv.png" alt="" />
			</div>
				...
				<div class="lcontent__items">
					<div class="lcontent__items_item">
						...
						<h1 class="lcontent_title">
							...
							<span class="location">в Москве и области</span>
							<span>
								от
								<span class="animate_number"><i>1</i><i>0</i><i>0</i></span>
								<span class="rouble">8</span>/м<sup>2</sup>
							</span>
						</h1>
						<p class="lcontent_subtitle">
							Оставьте ваш номер телефона для расчёта натяжного потолка по
							WhatsApp и получите купон на сумму 5000
							<span class="rouble">8</span> в подарок!
						</p>
			...
			<div class="modal" v-if="$store.state.isModal">
				...
				<div class="modal__container" v-else>
					...
					<div class="modal__lcontent">
						...
						<a :href="$store.state.siteUrl" class="btn btn_purple btn_pulse"
							><span>Перейти на сайт</span></a
						>
						<!--<span class="modal_linkClose" @click="toogleModal">Закрыть</span>-->
						<div class="modal_icons">
							<div class="modal_icons_item">
								...
								<div class="modal_icons_item_text">
...
<style lang="scss">
	...
	.lcontent {
		background-image: url("/potolki/images/stretch-ceiling-usa-14.jpg");
